...
<div class="si-post">
	...
	<div class="si-post-meta">
		<span class="si-post-author"><b class="glyphicon glyphicon-user"></b> Por <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php the_author_meta( 'display_name' ); ?></a> em <?php echo get_the_date("d/m/Y"); ?></span>
